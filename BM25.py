...
class BM25:
    ...
    def __init__(self, index, DL, index_type, page_rank_log, k1=1.5, b=0.75):
        self.b = b
        self.k1 = k1
        self.index = index
        self.DL = DL
        ...
        self.page_rank_log = page_rank_log
        self.bucket_name = "205963135"
    ...
    def read_posting_list(self, index, w):
        ...
        with closing(MultiFileReader(self.bucket_name)) as reader:
            ...
            for i in range(index.df[w]):
                ...
                if self.index_type == "body" or self.index_type == "body_stem":
    ...
    def search(self, queries, N=3):
        ...
        for query_id, query in queries.items():
            ...
            searched_dict[query_id] = sorted(
                [(doc_id, round(self._score(query, doc_id, term_frequencies_dict), 5)) for doc_id in candidates],
    ...
    def _score(self, query, doc_id, term_frequencies_dict):
        ...
        for term in query:
            if doc_id in term_frequencies_dict[term]:
                ...
                score += (numerator / denominator) + 1.5 * self.page_rank_log[doc_id]
        return score
